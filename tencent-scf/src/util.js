...
const get_url = (event) => {
  // Direct hardcoded function URL - most reliable
  return 'https://1423524779-2te2bdcdch.ap-guangzhou.tencentscf.com';
}

module.exports = { format, get_url };
